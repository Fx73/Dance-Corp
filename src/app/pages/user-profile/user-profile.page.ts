...
@Component({
  ...
  standalone: true,
  imports: [IonLabel, IonImg, IonCardContent, IonCardTitle, IonCardHeader, IonItem, IonBadge, IonCard, IonText, IonContent, CommonModule, FormsModule, AccountComponent, HeaderComponent]
})
